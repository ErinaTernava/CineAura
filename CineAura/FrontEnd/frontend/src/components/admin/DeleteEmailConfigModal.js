...
const DeleteEmailConfigModal = ({ onConfirm, onCancel, isDeleting }) => {
  return (
    <div style={{
      position: 'fixed',
      top: 0,
      ...
      <div style={{
        ...
        <h3 style={{ 
          ...
          Confirm Email Configuration Deletion
        </h3>
        <p style={{ 
          color: '#ebd0ad',
          marginBottom: '25px',
          ...
          This action cannot be undone. The email configuration will be permanently removed and email functionality will be disabled.
        </p>
        <div style={{ 
          display: 'flex',
